...
namespace XOR_NeuralNetwork
{
    public  class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            train(epo);
            Console.WriteLine("Write the first number (1 or 0) 1 = black, 0 = red");
            double X = double.Parse(Console.ReadLine());
            Console.WriteLine("Write the Second number (1 or 0) 1 = black, 0 = red");
            ...
            Console.WriteLine("Hmm let's see. Based on my training I'd give it exactly " + OutPutNeuron1.output * 100 + "% chance of being a Black!");


            if (OutPutNeuron1.output>0.5)
            {
                Console.WriteLine("So my guess is that "+ X + " + " + Y +" Should be Black");
            }
            else
            {
                Console.WriteLine("So my guess is that "+X + " + " + Y + " Should be Red");
